...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['name' => 'assign-role-to-user' , 'description' => 'Assign role to user','guard_name'  =>  'api'],
            ...
            ['name' => 'give-permissions-to-user' , 'description' => 'Give permissions to user','guard_name'  =>  'api'],
            ...
            ['name' => 'user-edit' , 'description' => 'Edit user details','guard_name'  =>  'api'],
